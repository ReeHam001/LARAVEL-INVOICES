                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3" id="start_at">
                            ...
                            <div class="input-group">
                                ...
                                </div><input class="form-control fc-datepicker" value="{{ $start_at ?? '' }}" {{-- لو تنفذ الستارت ات --}}
...
<script>
    $(document).ready(function() {
        $('#invoice_number').hide(); // اخفاء الانبوت تبع رقم الفاتورة لما الصفحة تحمل
        $('input[type="radio"]').click(function() {
            if ($(this).attr('id') == 'type_div') {  // لو البحث بنوع الفاتورة
                $('#invoice_number').hide();
                $('#type').show();
                $('#start_at').show();
                $('#end_at').show();
            } else {
                $('#invoice_number').show();  // والا البحث برقم الفاتورة
                $('#type').hide();
                $('#start_at').hide();
                $('#end_at').hide();
            }
