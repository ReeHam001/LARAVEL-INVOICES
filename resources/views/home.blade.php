                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\Models\invoices::sum('Total'), 2) }} {{-- number_format  بجيب اجمالي الفواتير مشان الفاصلة العشرية --}}
                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">{{ \App\Models\invoices::count() }}</p> {{-- عددد الفواتير --}}
                            </div>
